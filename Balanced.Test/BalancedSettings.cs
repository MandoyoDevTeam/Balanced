...
namespace Balanced.Test
{
    public static class BalancedTestKeys
    {
        ...
        public const string CardTestId = "CC69G8Pu5km0cFa1FRcua08q";

        public const string CreditTestId = "CR69TwCRNkAYHR66JW2kcyai";

        public const string DebitTestId = "WD729bAwhbfYalUoIACAqROW";

        public const string HoldTestId = "HL728HVFVmEv8npBUgoTdBy2";

        public const string VerificationTestId = "BZ4vtqDl4rCGLPpSZCq3n7qM";

        public const string RefundTestId = "RF10rgZNl7A1cVNfohLzAW3m";
